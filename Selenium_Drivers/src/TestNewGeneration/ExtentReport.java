...
public class ExtentReport {
	...
	ExtentTest test; // Specifies what details needs to be populated on the report
	
	@BeforeTest
	public void startReport() 
	{
		extent = new ExtentReports(System.getProperty("user.dir") + "/test-output/Ownreport.html",true);
		extent.addSystemInfo("Host Name", "DESKTOP-SR6VTH5");
		extent.addSystemInfo("Environment", "QA");
		extent.addSystemInfo("User Name", "Bhumika");
	...
	// https://github.com/1bhumika4/iNetBankingVersion4.git
