...
public class javaScriptUtil {
	...
	/*
	 * public static void flash(WebElement element, WebDriver driver) { String
	 * bgcolor = element.getCssValue("backgroundColor"); for(int i=0;i<500;i++) {
	 * changeColor("#000000",element,driver); changeColor(bgcolor,element,driver);
	 * 
	 * 
	 * }
	 * 
	 ...
	 * 
	 * 
	 * public static void changeColor(String color, WebElement element, WebDriver
